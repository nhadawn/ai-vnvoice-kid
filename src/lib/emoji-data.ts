// AUTO-GENERATED from Unicode emoji-test.txt (15.1). Full emoji catalogue.
// Format per line: emoji|english name|group|subgroup
const RAW = `😀|grinning face|Smileys & Emotion|face-smiling
...
export const EMOJI: EmojiEntry[] = RAW.split("\n").map((l) => {
  const [e, n, g, s] = l.split("|");
  return { e, n, g, s };
});

export const GROUP_VI: Record<string, string> = {
  "Smileys & Emotion": "Cảm xúc & Mặt",
  "People & Body": "Người & Cơ thể",
  "Animals & Nature": "Động vật & Thiên nhiên",
  "Food & Drink": "Đồ ăn & Thức uống",
  "Travel & Places": "Đi lại & Nơi chốn",
  "Activities": "Hoạt động",
  "Objects": "Đồ vật",
  "Symbols": "Ký hiệu",
};

export const GROUP_ORDER = Object.keys(GROUP_VI);
